...
public class GreenhouseThemeFactory : IThemeFactory
{
    ...
    public Enemy CreateEnemy(int index, ISubject<NoiseData> noiseEvents, ISubject<EnemyDeathData> deathEvents, ISubject<EnemyHeardNoiseData> heardNoiseEvents, ISubject<SystemLogData> systemLogs)
    {
        ...
        {
            0 => new Enemy("Mutated Mandrake", "Plant", 25, 10, 1, noiseEvents, deathEvents, heardNoiseEvents, systemLogs, new CowardlyState(), new CowardlyBehavior()),
            1 => new Enemy("Carnivorous Plant", "Plant", 40, 18, 3, noiseEvents, deathEvents, heardNoiseEvents, systemLogs, new AggressiveState(), new AggressiveBehavior()),
            _ => new Enemy("Giant Spore", "Fungus", 35, 5, 0, noiseEvents, deathEvents, heardNoiseEvents, systemLogs,
